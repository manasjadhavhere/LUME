...
const CATEGORY_TILES = [
  { name: 'Bridal', image: 'https://images.unsplash.com/photo-1596755389378-c31d21fd1273?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
  { name: 'Editorial', image: 'https://images.unsplash.com/photo-1515688594390-b649af70d282?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
  { name: 'Evening Glam', image: 'https://images.unsplash.com/photo-1566977755106-4b9ee5625c50?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
  { name: 'Natural', image: 'https://images.unsplash.com/photo-1512413914583-11bf279a016f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
  { name: 'Fantasy & Bold', image: 'https://images.unsplash.com/photo-1516975080661-460d3d256877?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
];
...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (activeCategory !== 'All') params.append('specialty', activeCategory);
    if (searchQuery.trim()) params.append('search', searchQuery.trim());
    params.append('limit', '8');

    fetch(`${API_BASE}/api/artists?${params.toString()}`)
      .then(r => r.json())
      .then(data => {
      ...
      <section className="home-section home-partner" id="partner">
        ...
        <div className="home-container home-partner__inner">
          <div className="home-partner__content reveal">
            ...
            <button className="home-btn home-btn--light home-partner__cta" onClick={() => navigate('/register')}>
        ...
        <div className="home-container">
          <div className="home-cta__inner reveal">
            ...
            <p className="home-cta__sub">
              Join thousands of satisfied clients who trust Lume for their beauty needs.
            </p>
